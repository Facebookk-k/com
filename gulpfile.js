...
gulp.task('js:vendor', function (done) {
    gulp.src(path.src.vendor)
        .pipe(order([
            'app/plugins/jquery-3.4.0.min.js',
            'app/plugins/scrollbar/jquery.mCustomScrollbar.concat.min.js',
            'app/plugins/fancybox/jquery.fancybox.min.js',
            'app/plugins/formstyler/js/jquery.formstyler.min.js',
            'app/plugins/**/*.js',
        ], {base: './'}))
